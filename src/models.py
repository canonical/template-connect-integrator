...
from literals import PEER_REL, SUBSTRATE, Substrates
...
class Context(WithStatus, Object):
    ...
    def __init__(self, charm: "IntegratorCharm", substrate: Substrates):
        ...
        # self.requirer_interface = KafkaConnectRequirerData(
        #     self.model, relation_name=CONNECT_REL, plugin_url=charm.integrator.plugin_url
        # )
